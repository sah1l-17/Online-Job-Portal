...
<head>
	...
	<title>Online Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> VIT, <br/> Mumbai, <br/>India</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:sahil@gmail.com">sahil@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91 9619519031">+91 9619519031</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>This Portal is a online job management system developed by VIT students.</p>
							...
							<h5 class="footer-title">Job Portal Contact</h5>
								...
								<p>Address : VIT, Mumbai</p>
								<p>Email : <a href="mailto:sahl@gmail.com">sahil@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+91 9619519031</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> INFT B Students</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by VIT students</a></li>
								</ul>
