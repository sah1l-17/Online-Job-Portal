						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								?>
									...
									<div class="form-group">
									<label>Country</label>
									<select name="country" required class="selectpicker show-tick form-control" data-live-search="false">
									<option disabled value="">Select</option>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>This Portal is an online job management system developed by VIT students</p>
